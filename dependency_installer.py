...
Supports Numba for accelerated hydrological algorithms
...
class DependencyInstaller:
    ...
    def _install_single_package(self, python_exe: str, package: str) -> tuple:
        ...
        try:
            ...
            result = subprocess.run(
                ...
                capture_output=True,
                text=True,
                timeout=600,  # 10 minute timeout for numba (it's large)
    ...
    def _show_success_dialog(self, count: int):
        ...
        QMessageBox.information(
            ...
            "✓ Numba is now available for accelerated processing.\n\n"
            "You can continue using the plugin. The accelerated algorithms \n"
            "will be used automatically for improved performance."
        )
...
class DependencyInstallDialog(QDialog):
    ...
    def __init__(self, parent, packages: list, plugin_name: str):
        ...
        benefits = QLabel(
            "<p><b>Benefits of Numba:</b></p>"
            "<ul>"
            "<li>Flow Direction: ~20x faster</li>"
            "<li>Flow Accumulation: ~50x faster</li>"
            "<li>Watershed Delineation: ~30x faster</li>"
            "</ul>"
        )
        ...
        skip_btn = QPushButton("Skip (Use slower mode)")
